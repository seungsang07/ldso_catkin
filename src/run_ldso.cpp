...
std::string source = "/home/jhlee/data/tumvo/sequence_36/images.zip";
std::string calib = "/home/jhlee/data/tumvo/sequence_36/camera.txt";
std::string output_file = "/home/jhlee/ws_depthevo/src/ldso/results.txt";
std::string vocPath = "/home/jhlee/ws_depthevo/src/ldso/vocab/orbvoc.dbow3";
